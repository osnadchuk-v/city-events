...
describe('NavLink Component', () => {
  ...
  it('renders correctly with label and icon', () => {
    render(<NavLink href="/dashboard" label="Dashboard" icon={<span data-testid="test-icon">Icon</span>} />);
  ...
  it('applies inactive styles when isActive is false', () => {
    render(<NavLink href="/dashboard" label="Dashboard" icon={<span>Icon</span>} isActive={false} />);
