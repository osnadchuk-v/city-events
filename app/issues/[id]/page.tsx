...
const IssuePage = async ({ params }: { params: Promise<{ id: string }> }) => {
  ...
  return (
    <div className="max-w-4xl mx-auto p-4 md:p-8">
      ...
      <div className="bg-gray-800 text-gray-50 dark:bg-dark-elevated border border-gray-200 dark:border-dark-border-default rounded-lg shadow-sm p-6 mb-8">
      ...
      <div className="bg-gray-800 text-gray-50 dark:bg-dark-elevated border border-gray-200 dark:border-dark-border-default rounded-lg shadow-sm p-6">
